...
const CategoryMenu = ({ categories, selectedCategory, onSelectCategory }) => {
    ...
    // Prepend 'All' to the categories array for the menu
    const menuCategories = ['All', ...categories.map(cat => cat.category_name)];
    ...
    return (
        <div className="category-menu-container w-100" style={{position:'relative'}}>
            ...
            <div className="d-lg-none d-flex justify-content-between align-items-center">
                ...
                >
                    <span className={`caret-icon ${isMenuOpen ? 'up' : 'down'}`}></span>
                </button>
            </div>
